<div class="panel">
	<ul class="nav nav-tabs" id="myTab">
		...
		<li class="active"><a>Inactive users</a></li>
		<li><a href="<?php echo base_url('admindb/deleteuserlist');?>">Deleted users</a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane active" id="inactiveuser">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="row">
						<div class="col-lg-6">
							<span class="glyphicon glyphicon-list"></span>Inactiv User List
						</div>
						<!--<div class="col-lg-6">
							<form>
				...
				?>
						<li class="list-group-item">
							...
							<div class="pull-right action-buttons">
								...
								<a class="trash"><span onclick="deleteuser(<?php echo $userlist['id']; ?>,'inact');" class="glyphicon glyphicon-trash"></span></a>
