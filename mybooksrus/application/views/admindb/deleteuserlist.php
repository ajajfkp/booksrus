			...
			<div class="panel panel-primary">
				...
				?>
						<li class="list-group-item">
							<div class="checkbox">
								<a href="<?php echo base_url('admindb/viewuser/'.$userlist['id'].'/del')?>">
									<label for="checkbox">
							...
							<div class="pull-right action-buttons">
								<a href="<?php echo base_url('admindb/viewuser/'.$userlist['id'].'/del')?>"><span class="glyphicon glyphicon-pencil"></span></a>
