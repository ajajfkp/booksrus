			...
			<div class="panel panel-primary">
				...
				?>
						<li class="list-group-item">
							<div class="checkbox">
								<a href="<?php echo base_url('admindb/viewuniv/'.$schoolList['id'].'/act')?>">
									<label for="univ_name">
										<?php echo ucfirst($schoolList['name']);?>
									</label>
								</a>
								<a href="http://<?php echo $schoolList['website']; ?>" target="_blank">
									<label for="univ_url">
										<?php echo $schoolList['website']; ?>
									</label>
								</a>
							</div>
							<div class="pull-right action-buttons">
								<a href="<?php echo base_url('admindb/viewuniv/'.$schoolList['id'].'/act');?>"><span class="glyphicon glyphicon-pencil"></span></a>
