<div class="btn-group btn-group-justified">
	<a href="<?php echo base_url('admindb/userlist'); ?>" class="btn btn-primary col-sm-3" style="white-space:normal;">
		<i class="glyphicon glyphicon-user"></i>
		<br> Registerd Users
		<br> <span class="badge badge-info"><?php echo $this->utilities->getTotalUsers(1); ?></span>
	</a>
	<a href="<?php echo base_url('admindb/schoolList'); ?>" class="btn btn-primary col-sm-3" style="white-space:normal;">
