<div class="row">
	<div class="col-lg-12">
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo base_url('message/sent');?>"><span class="glyphicon glyphicon-user"></span>
				Sent</a></li>
		...
		<div class="tab-content">
			...
			?>
						<a href="<?php echo base_url('message/showmessages/'.$inboxMsg['transid'].'/inbox'); ?>" class="list-group-item <?php echo (($inboxMsg['isread']>1)?"read":""); ?>">
							<div class="row">
							<div class="col-lg-4">
								<div class="checkbox">
									<label>
