...
class SearchModel extends CI_Model {
	...
	function getBookList($searchBy){
		$sql = "select t1.id bookid,t1.isbn10,t1.isbn13,t1.name title,t1.discription,t1.authors,
			...
			where t2.active_status ='1' and t2.transaction_typt='1' and (t1.name like '%".$searchBy."%' or t1.authors like '%".$searchBy."%' or t1.isbn10 like '%".$searchBy."%' or t1.isbn13 like '%".$searchBy."%')";
